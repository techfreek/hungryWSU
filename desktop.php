	...
	else
	{
		...
		foreach ($results as $restaurant)
		{
			...
			if($restaurant['sponsored'] == 1)
			{
				...
				{
					echo '<div class="pure-u-1-3"><div id="name"><img class="promoStar" alt="Sponsored Result" src="whitePromo.png"><a target=”_blank” href="' . $restaurant['website'] . '">' . $restaurant['name'] . '</a></div></div>';
				}
				else
				{
			...
			else
			{
				if($restaurant['website'] != null)
				{
					echo '<div class="pure-u-1-3"><div id="name"><a target=”_blank” href="' . $restaurant['website'] . '">' . $restaurant['name'] . '</a></div></div>';
				}
				else
				{
